...
-- 길신(吉神) 데이터 - 총 20개
INSERT INTO sinsal_master (sinsal_name, sinsal_hanja, sinsal_type, icon, category, priority, description, detail_description, effect_positive, effect_negative, is_active) VALUES
-- 1. 천을귀인
('천을귀인', '天乙貴人', '길신', '☀️', '귀인', 100,
...
-- 천을귀인 규칙
INSERT INTO sinsal_rule (sinsal_id, rule_type, condition_ilgan, condition_target, match_position, description) VALUES
...
INSERT INTO sinsal_rule (sinsal_id, rule_type, condition_yenji, condition_target, match_position, description) VALUES
(23, 'YENJI_TO_ANY', '[]', '["묘"]', 'any', '묘가 있으면 도화살'),
...
-- 괴강살 규칙 (일주 기준)
INSERT INTO sinsal_rule (sinsal_id, rule_type, condition_ilgan, condition_target, match_position, description) VALUES
(31, 'ILJU_COMBINATION', '["경"]', '["술"]', 'day', '경술일주면 괴강살'),
...
-- 천덕귀인 규칙 (2번)
INSERT INTO sinsal_rule (sinsal_id, rule_type, condition_yenji, condition_target, match_position, description) VALUES
(2, 'YENJI_TO_ANY', '["자"]', '["정"]', 'any', '자년에 정이 있으면 천덕귀인'),
...
-- 월덕귀인 규칙 (3번)
INSERT INTO sinsal_rule (sinsal_id, rule_type, condition_yenji, condition_target, match_position, description) VALUES
(3, 'YENJI_TO_ANY', '["자"]', '["병"]', 'any', '자년에 병이 있으면 월덕귀인'),
...
INSERT INTO sinsal_rule (sinsal_id, rule_type, condition_yenji, condition_target, match_position, description) VALUES
(16, 'YENJI_TO_ANY', '["자"]', '["무"]', 'any', '자년에 무가 있으면 천사귀인'),
...
-- 백호대살 규칙 (25번)
INSERT INTO sinsal_rule (sinsal_id, rule_type, condition_yenji, condition_target, match_position, description) VALUES
(25, 'YENJI_TO_ANY', '["인", "오", "술"]', '["유"]', 'any', '인오술년에 유가 있으면 백호대살'),
...
-- 원진살 규칙 (32번) - 대립 지지
INSERT INTO sinsal_rule (sinsal_id, rule_type, condition_yenji, condition_target, match_position, description) VALUES
(32, 'YENJI_TO_ANY', '["자"]', '["미"]', 'any', '자와 미는 원진'),
...
INSERT INTO sinsal_rule (sinsal_id, rule_type, condition_yenji, condition_target, match_position, description) VALUES
(33, 'YENJI_TO_ANY', '["자"]', '["미"]', 'any', '자와 미는 육해'),
...
-- 과신살 규칙 (37번)
INSERT INTO sinsal_rule (sinsal_id, rule_type, condition_yenji, condition_target, match_position, description) VALUES
(37, 'YENJI_TO_ANY', '["인", "오", "술"]', '["인"]', 'any', '인오술년에 인이 있으면 과신살'),
...
-- 홍염살 규칙 (31번) - 일간별 홍염살
INSERT INTO sinsal_rule (sinsal_id, rule_type, condition_ilgan, condition_target, match_position, description) VALUES
(31, 'ILGAN_JIJI', '["갑"]', '["오"]', 'any', '갑일에 오가 있으면 홍염살'),
...
-- 정록 규칙 (32번) - 일간별 정록 지지
INSERT INTO sinsal_rule (sinsal_id, rule_type, condition_ilgan, condition_target, match_position, description) VALUES
(32, 'ILGAN_JIJI', '["갑"]', '["인"]', 'any', '갑일에 인이 있으면 정록'),
...
-- 천문성 규칙 (33번) - 월지별 천문성
INSERT INTO sinsal_rule (sinsal_id, rule_type, condition_ilgan, condition_target, match_position, description) VALUES
(33, 'ILGAN_JIJI', '["갑"]', '["인"]', 'month', '갑일에 월지가 인이면 천문성'),
...
INSERT INTO sinsal_rule (sinsal_id, rule_type, condition_yenji, condition_target, match_position, description) VALUES
(49, 'YENJI_TO_ANY', '[]', '["묘"]', 'any', '묘가 있으면 귀문관살'),
